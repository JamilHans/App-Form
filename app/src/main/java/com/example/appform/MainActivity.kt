...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val countries = arrayOf("Argentina", "Bolivia", "Chile", "Colombia", "Ecuador", "España","Estados Unidos", "Mexico", "Panama", "Peru","Uruguay")
        ...
        binding.etDateBirth.setOnClickListener {
            ...
            picker.addOnPositiveButtonClickListener {timeInMilliseconds ->
                val datStr = SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).apply {
                    timeZone = TimeZone.getTimeZone("UTC")
                }.format(timeInMilliseconds)
                binding.etDateBirth.setText(datStr)
            }
